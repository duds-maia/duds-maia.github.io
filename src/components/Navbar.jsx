    ...
    <>
      <div className={`mobile-menu ${menuOpen ? 'active' : ''}`}>
        ...
        <a
          ...
          onClick={(e) => { e.preventDefault(); setMenuOpen(false); window.open("https://wa.me/5553981231850?text=Olá!%20Vi%20seu%20portfólio%20e%20gostaria%20de%20conversar%20sobre%20um%20projeto.", "_blank"); if(window.fbq){window.fbq('track','Contact');window.fbq('track','Lead');} }}
